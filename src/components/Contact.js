...
import image from '../assets/images/mailbox.webp';
    ...
    return (
        <section className='contact'>
            ...
            <div className='contact-row'>
                <motion.img loading='lazy' initial={{opacity: 0, x: -50}} whileInView={{opacity: 1, x: 0}} viewport={{once: true}} transition={{duration: 1}} src={image} alt="Boite aux lettres avec courrier entrant et sortant" />
                <Form />
            </div>
            </div>
        </section>
